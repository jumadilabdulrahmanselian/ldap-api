...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                        ...
                        <div class="login-signin">
                            ...
                            <form class="form text-left" id="kt_login_signin_form">
                                ...
                                <div class="text-center mt-15">
                                    <button id="kt_login_signin_submit" class="btn btn-primary btn-pill shadow-sm py-4 px-9 font-weight-bold"><?= getLangKey('enter_btn_auth'); ?></button>
                                </div>
                            </form>
                        </div>
                        <!--end:Sign In Form-->
    ...
    <script src="<?= assetsUri(); ?>js/pages/custom/login/login-general.js"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
