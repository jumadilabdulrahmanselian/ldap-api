$("#kt_datatable1 tbody").on("click", ".deleteTemuan", function () {
  ...
  Swal.fire({
    ...
    if (result.value) {
      $.ajax({
        url: BASE + "lai_tindak_lanjut/deletetemuan",
        data: { id: id },
        method: "post",
...
$("#tipeElement").on("change", function () {
  ...
  $.ajax({
    url: BASE + "lai_tindak_lanjut/get_element_by_tipe",
    data: { tipe: tipe },
    method: "post",
...
$("#kt_datatable1 tbody").on("click", ".updateStatus", function () {
  ...
  Swal.fire({
    ...
    if (result.value) {
      $.ajax({
        url: BASE + "lai_tindak_lanjut/statustemuan",
        data: { id: id },
        method: "post",
        success: function (response) {
          var data = JSON.parse(response);
...
$("#kt_datatable1 tbody").on("click", ".tambahProgress", function () {
  ...
  button_action({
    ...
    btnLabel: "Simpan",
    type: "edit",
    url: BASE + "lai_tindak_lanjut/progress",
    modal: "modalProgress",
    form: "form_progress",
  });

  $.ajax({
    url: BASE + "lai_tindak_lanjut/getedittemuan",
    data: { id: id },
    method: "post",
    success: function (data) {
...
$("#kt_datatable1 tbody").on("click", ".tombolEdit", function () {
  ...
  button_action({
    ...
    btnLabel: "Ubah Data",
    type: "edit",
    url: BASE + "lai_tindak_lanjut/edittemuan",
    modal: "modalEdit",
    form: "form_edit",
  });
  ...
  return {
    ...
    init: function () {
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        // resources: BASE + "lai_tindak_lanjut/load_resource",
        events: BASE + "lai_tindak_lanjut/load_event/" + IDLAI,
      ...
      $("#submit").on("click", function (e) {
        ...
        validation.validate().then(function (status) {
          ...
          if (status == "Valid") {
            // alert("Modal Sesuai");
            $.ajax({
              url: BASE + "lai_tindak_lanjut/addtemuan",
              method: "POST",
              data: _input,
              contentType: false,
              cache: false,
    ...
    if (isSelectorExist("#form_obs")) {
      ...
      $("#submitObs").on("click", function (e) {
        ...
        validation.validate().then(function (status) {
          ...
          if (status == "Valid") {
            $.ajax({
              url: BASE + "lai_tindak_lanjut/addfileobs",
              method: "POST",
              data: _input,
              contentType: false,
              cache: false,
