...
var FullCalendar = (function (e) {
    ...
    for (n.__e = E, p = D; p--; )
      null != b[p] &&
        ("function" == typeof n.type &&
          ...
          (n.__d = S(r, p + 1)),
        O(b[p], b[p]));
    if (C) for (p = 0; p < C.length; p++) H(C[p], C[++p], C[++p]);
  }
  ...
  function x(e, t, n, r, o) {
    ...
    e: if ("style" === t)
      ...
      (i = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + i] = n),
        n
          ? r || e.addEventListener(t, i ? M : k, i)
          : e.removeEventListener(t, i ? M : k, i);
  ...
  function P(e, t, n, r, o, a, s, l, u) {
    ...
    try {
      e: if ("function" == typeof w) {
        if (
          ((E = t.props),
          (C = (c = w.contextType) && r[c.__c]),
          (b = c ? (C ? C.props.value : c.__) : r),
          n.__c
          ...
          null != w.getDerivedStateFromProps &&
            ...
            f(d.__s, w.getDerivedStateFromProps(E, d.__s))),
          (h = d.props),
          (v = d.state),
          p)
        )
          ...
          if (
            (null == w.getDerivedStateFromProps &&
              ...
              d.componentWillReceiveProps(E, b),
            (!d.__e &&
              null != d.shouldComponentUpdate &&
              !1 === d.shouldComponentUpdate(E, d.__s, b)) ||
              t.__v === n.__v)
          ) {
            (d.props = E),
              (d.state = d.__s),
          ...
          null != d.componentWillUpdate && d.componentWillUpdate(E, d.__s, b),
    ...
    if (null === m) v === g || (s && e.data === g) || (e.data = g);
      ...
      s ||
        ("value" in g &&
          ...
          x(e, "value", y, v.value, !1),
        "checked" in g &&
          void 0 !== (y = g.checked) &&
          y !== e.checked &&
          x(e, "checked", y, v.checked, !1));
    }
    return e;
  }
    ...
    : (ge.FullCalendarVDom = {
        ...
        flushToDom: function () {
          ...
          (i.debounceRendering = n),
            W(v(me, {}), document.createElement("div"));
  ...
  function Fe(e, t, n) {
    var r, o;
    for (r = 0; r < n.length; r += 1) if ((o = Ge(e, t, n[r]))) return o;
    return 0;
  }
  ...
  function ot(e, t) {
    return ft(e) === ft(t) ? Math.round(tt(e, t)) : null;
  }

  function it(e) {
    return dt([e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate()]);
  }

  function at(e, t, n, r) {
    var o = dt([t, 0, 1 + st(t, n, r)]),
      i = it(e),
      a = Math.round(tt(o, i));
  ...
  function st(e, t, n) {
    var r = 7 + t - n;
    return -((7 + dt([e, 0, r]).getUTCDay() - t) % 7) + r - 1;
  }
  ...
  function Ct(e, t) {
    if (e === t) return !0;
    for (var n in e) if (vt.call(e, n) && !(n in t)) return !1;
    for (var n in t) if (vt.call(t, n) && e[n] !== t[n]) return !1;
    return !0;
  }

  function bt(e, t) {
    var n = [];
    for (var r in e) vt.call(e, r) && (r in t || n.push(r));
    for (var r in t) vt.call(t, r) && e[r] !== t[r] && n.push(r);
    return n;
  }
  ...
  function _t(e, t, n, r, o) {
    ...
    return e.allDay && (i = i.map(it)), i;
  }
  var xt = ["years", "months", "days", "milliseconds"],
  ...
  function Ut(e, t) {
    for (var n = null, r = 0; r < xt.length; r += 1) {
      var o = xt[r];
      if (t[o]) {
        var i = e[o] / t[o];
        if (!Ze(i) || (null !== n && n !== i)) return null;
        n = i;
  ...
  function Ft(e) {
    return (
      qe(e.getUTCHours(), 2) +
      ":" +
      qe(e.getUTCMinutes(), 2) +
      ":" +
      qe(e.getUTCSeconds(), 2)
    );
  }
    ...
    on = (function () {
      function e(e) {
        ...
        (this.standardDateProps = t),
          ...
          (this.severity = r),
          (this.buildFormattingFunc = Yt(an));
      }
      return (
      ...
      : (function (e, t, n) {
          ...
          return function (r) {
            ...
            return (function (e, t, n, r, o) {
              ...
              r.omitCommas && (e = e.replace(en, "").trim());
  ...
  var un = (function () {
      ...
      return (
        (e.prototype.format = function (e, t, n) {
          return t.cmdFormatter(this.cmdStr, ln(e, null, t, n));
        }),
        (e.prototype.formatRange = function (e, t, n, r) {
          return n.cmdFormatter(this.cmdStr, ln(e, t, n, r));
        }),
        e
      );
    })(),
    cn = (function () {
      ...
      return (
        (e.prototype.format = function (e, t, n) {
          return this.func(ln(e, null, t, n));
        }),
        (e.prototype.formatRange = function (e, t, n, r) {
          return this.func(ln(e, t, n, r));
        }),
        e
      );
    })();
  ...
  var pn = {
      ...
      buttonIcons: Cn,
      customButtons: Cn,
      defaultAllDayEventDuration: Mt,
      defaultTimedEventDuration: Mt,
      nextDayThreshold: Mt,
      scrollTime: Mt,
  ...
  var Hn = { id: String, groupId: String, title: String, url: String },
    On = { start: Cn, end: Cn, date: Cn, allDay: Boolean },
    An = r(r(r({}, Hn), On), { extendedProps: Cn });
  ...
  function Wn(e, t, n, r, o) {
    ...
    var c,
      d = (function (e, t, n, r) {
        ...
        a && s && (s = it(s));
        i && ((u = i.marker), a && (u = it(u)), s && u <= s && (u = null));
        u
          ? (l = !0)
          : r ||
    ...
    return d
      ? {
          def: (c = Bn(a, s, t ? t.sourceId : "", d.allDay, d.hasEnd, n)),
          instance: ht(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo),
        }
      : null;
  }

  function Ln(e, t, n) {
    return void 0 === n && (n = Un(t)), En(e, n);
  }

  function Un(e) {
    return r(r(r({}, kn), An), e.pluginHooks.eventRefiners);
  }
  ...
  function Vn(e, t) {
    ...
    return (
      e.start && ((n = it(e.start)), r && r <= n && (r = Je(n, 1))),
      { start: n, end: r }
    );
  }
  ...
  function Fn(e) {
    var t = Vn(e);
    return tt(t.start, t.end) > 1;
  }

  function Gn(e, t, n, r) {
    return "year" === r
      ? Mt(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? Mt(n.diffWholeMonths(e, t), "month")
      : nt(e, t);
  }
  ...
  function Jn(e, t, n, r) {
    ...
    for (var m in o)
      for (var y = 0, S = jn(o[m], n); y < S.length; y++) {
        var E,
          C = S[y];
        f = u[(E = a[m]).defId];
        s.push({
    ...
    for (var c in i)
      for (var b = 0, D = jn(i[c], n); b < D.length; b++) {
        C = D[b];
        s.push({
          def: e.defs[c],
          ui: u[c],
  ...
  function ur(e, t, n, r, o, i, a) {
    ...
    var f = p.range.start,
      ...
      m = it(f).valueOf() === it(v).valueOf(),
      y = it(Qe(h, -1)).valueOf() === it(Qe(g, -1)).valueOf();
  ...
  var fr = { start: Cn, end: Cn, allDay: Boolean };
  ...
  function gr(e, t, n) {
    return r(r({}, mr(e, t, n)), { timeZone: t.timeZone });
  }
  ...
  function yr(e, t, n) {
    var r = Ln({ editable: !1 }, n),
      o = Bn(r.refined, r.extra, "", e.allDay, !0, n);
    return {
      def: o,
      ui: rr(o, t),
      instance: ht(o.defId, e.range),
      range: e.range,
      isStart: !0,
      isEnd: !0,
    };
  ...
  function Er(e, t) {
    ...
    return (
      r(
        ...
        ((n = e),
        (o = t.dateEnv),
        r(r({}, mr(n.range, o, n.allDay)), { allDay: n.allDay }))
      ),
      i
    );
  }
  ...
  function Cr(e, t, n) {
    ...
    return (
      e
        ? ((i = it(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
  ...
  function br(e, t, n, r) {
    ...
    for (var l in e.instances) {
      var u = e.instances[l];
      s = i.defs[u.defId];
      i.instances[l] = Rr(u, s, o[u.defId], n, r);
    }
    return i;
  }
  ...
  function Rr(e, t, n, o, i) {
    ...
    return (
      ...
      l &&
        (u.range = {
          start: u.range.start,
          end: Cr(t.allDay, u.range.start, i),
        }),
      t.allDay &&
        (u.range = { start: it(u.range.start), end: it(u.range.end) }),
      u.range.end < u.range.start &&
        (u.range.end = Cr(t.allDay, u.range.start, i)),
      u
    );
  }
  var wr = (function () {
  ...
  function xr(e) {
    return r(r(r({}, kn), Tr), e.pluginHooks.eventSourceRefiners);
  }
  ...
  var Mr = (function () {
      ...
      return (
        ...
        (e.prototype.formatDate = function (e, t) {
          ...
          return n.format(n.createMarker(e), dn(t));
        }),
        (e.prototype.formatRange = function (e, t, n) {
          var r = this.getCurrentData().dateEnv;
          return r.formatRange(r.createMarker(e), r.createMarker(t), dn(n), n);
        }),
        ...
        (e.prototype.addEvent = function (e, t) {
          if (e instanceof Pr) {
            ...
            return (
              this.getCurrentData().eventStore.defs[n.defId] ||
                (this.dispatch({
                  type: "ADD_EVENTS",
                  eventStore: Dn({ def: n, instance: r }),
                }),
          ...
          var s = Wn(e, o, i, !1);
          if (s) {
            var l = new Pr(i, s.def, s.def.recurringDef ? null : s.instance);
            return (
              this.dispatch({ type: "ADD_EVENTS", eventStore: Dn(s) }),
        ...
        (e.prototype.triggerEventAdd = function (e) {
          ...
          this.getCurrentData().emitter.trigger("eventAdd", {
            ...
            relatedEvents: [],
            revert: function () {
              t.dispatch({ type: "REMOVE_EVENTS", eventStore: Ir(e) });
            },
          });
        }),
        (e.prototype.getEventById = function (e) {
          ...
          for (var i in ((e = String(e)), r)) {
            var a = r[i];
            if (a.publicId === e) {
              if (a.recurringDef) return new Pr(t, a, null);
              for (var s in o) {
                var l = o[s];
                if (l.defId === a.defId) return new Pr(t, a, l);
              }
            }
          }
          return null;
      ...
      return (
        ...
        (e.prototype.setDates = function (e, t, n) {
          ...
          if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
            ...
            !0 === n.allDay && (u = zn(u));
            var c = Gn(u.start, l, a, n.granularity);
            if (r) {
              var d = Gn(u.end, r, a, n.granularity);
              (i = d),
                (o = c).years === i.years &&
                o.months === i.months &&
                o.days === i.days &&
  ...
  function Nr(e, t, n) {
    ...
    for (var s in o) {
      var l = o[s],
        u = r[l.defId];
      l.instanceId !== a && i.push(new Pr(t, u, l));
    }
    return i;
  }
  var Hr = {};
  ...
  var Ur = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return ft(e) === ft(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.timestampToMarker = function (e) {
          return "local" === this.timeZone
            ...
            ? dt(this.namedTimeZoneImpl.timestampToArray(e))
            : new Date(e);
        }),
        (e.prototype.offsetForMarker = function (e) {
          return "local" === this.timeZone
            ? -ut(ct(e)).getTimezoneOffset()
            : "UTC" === this.timeZone
            ? 0
  ...
  function jr(e) {
    ...
    return new Ur(
      r(r({ timeZone: fn.timeZone, calendarSystem: "gregory" }, e), {
        locale: t,
      })
    );
  }
  ...
  var no = { defs: {}, instances: {} },
    ro = (function () {
      function e() {
        (this.getKeysForEventDefs = Yt(this._getKeysForEventDefs)),
          (this.splitDateSelection = Yt(this._splitDateSpan)),
          (this.splitEventStore = Yt(this._splitEventStore)),
          (this.splitIndividualUi = Yt(this._splitIndividualUi)),
          (this.splitEventDrag = Yt(this._splitInteraction)),
          (this.splitEventResize = Yt(this._splitInteraction)),
      ...
      return (
        (e.prototype.splitProps = function (e) {
          var t = this,
            ...
            u = {};
          for (var c in ((this.eventUiBuilders = yt(n, function (e, n) {
            return t.eventUiBuilders[n] || Yt(oo);
          })),
          n)) {
            var d = n[c],
              p = a[c] || no,
          ...
          if (e) {
            var n = this._splitEventStore(
              ...
              i = function (r) {
                t[r] ||
                  (t[r] = {
                    affectedEvents: n[r] || no,
                    mutatedEvents: o[r] || no,
                    isEvent: e.isEvent,
                  });
              };
            for (var a in n) i(a);
  ...
  function io(e, t, n, r) {
    return {
      dow: e.getUTCDay(),
      isDisabled: Boolean(r && !$n(r.activeRange, e)),
      isOther: Boolean(r && !$n(r.currentRange, e)),
  ...
  function so(e, t) {
    var n = ["fc-slot", "fc-slot-" + Ke[e.dow]];
    return (
      e.isDisabled
  ...
  function lo(e, t) {
    return (
      void 0 === t && (t = "day"), JSON.stringify({ date: Vt(e), type: t })
    );
  }
  var uo,
    co = null;
  ...
  function go(e, t, n) {
    void 0 === t && (t = !1);
    var r = n ? e.getBoundingClientRect() : mo(e),
      o = vo(e, t),
      i = {
  ...
  function Wo(e, t, n, r, o, i, a, s, l, u, c, d, p) {
    return {
      ...
      createScrollResponder: function (e) {
        return new Oo(e, u, Mt(n.scrollTime), n.scrollTimeReset);
      },
  ...
  var Lo = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(bt(e, this.props), bt(t, this.state)),
          !Dt(this.props, e, this.propEquality) ||
            !Dt(this.state, t, this.stateEquality)
        );
      }),
      (t.addPropsEquality = Bo),
  ...
  (qo.prototype.classes = {
    ...
    (qo.prototype.baseIconClass = "fc-icon"),
    (qo.prototype.iconClasses = {
      close: "fc-icon-x",
    ...
    (qo.prototype.rtlIconClasses = {
      prev: "fc-icon-chevron-right",
      next: "fc-icon-chevron-left",
      prevYear: "fc-icon-chevrons-right",
      nextYear: "fc-icon-chevrons-left",
    }),
    (qo.prototype.iconOverrideOption = "buttonIcons"),
    (qo.prototype.iconOverrideCustomButtonOption = "icon"),
    (qo.prototype.iconOverridePrefix = "fc-icon-");
  var Zo = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
  ...
  function Ko(e) {
    return _o(Xo.Consumer, null, function (t) {
      return _o($o, r({ renderId: t }, e));
    });
  }
  var $o = (function (e) {
      function t() {
      ...
      return (
        ...
        (t.prototype.getInnerContent = function () {
          var e = this.props,
            t = ti(e.content, e.hookProps);
          return (
            void 0 === t && (t = ti(e.defaultContent, e.hookProps)),
            null == t ? null : t
          );
        }),
  ...
  function Qo() {
    ...
    return function (r, o) {
      return (
        (t && Ct(t, o) && r === e) || ((e = r), (t = o), (n = ei(r, o))), n
      );
    };
  }
  ...
  var ni = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.normalizeClassNames = Qo()), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function oi(e) {
    ...
    return (
      n.content &&
        ((t = n),
        (o = function (e) {
          return _o(Ao.Consumer, null, function (n) {
            return _o(ni, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
  ...
  function ii(e, t, n, o) {
    ...
    return yt(
      (function (e, t) {
        var n,
          r = {};
        for (n in e) Yo(n, r, e, t);
        for (n in t) Yo(n, r, e, t);
        return r;
      })(i, a),
      function (e) {
        return (function (e, t, n, o, i) {
          ...
          return {
            ...
            buttonTextDefault: p(i) || e.defaults.buttonText || p(fn) || e.type,
          };
        })(e, a, t, n, o);
      }
    );
  ...
  var si = (function () {
    ...
    return (
      ...
      (e.prototype.buildCurrentRangeInfo = function (e, t) {
        ...
        return (
          r.duration
            ...
            : ((i = Bt((o = this.getFallbackDuration())).unit),
              (a = this.buildRangeFromDuration(e, t, o, i))),
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            (Ot(o) < 0 && ((a = it(a)), (a = n.add(a, o))),
            Ot(i) > 1 && ((s = Je((s = it(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        );
      }),
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Ot(n) <= 1 &&
            this.isHiddenDay(o) &&
            (o = it((o = this.skipHiddenDays(o, t)))),
          d(),
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? Mt(1, t) : e || Mt({ days: 1 }))
        );
      }),
  ...
  function ui(e, t, n, o) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return fi(
          e,
          t.sourceIds ? St(t.sourceIds) : vi(e, o),
          s,
          t.isRefetch || !1,
          o
        );
    ...
    return fi(
      ...
      mt(e, function (e) {
        return (function (e, t, n) {
          if (!gi(e, n)) return !e.latestFetchId;
          return (
  ...
  function mi(e, t, n, r, o) {
    switch (t.type) {
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, o, i) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (a = Tt(a, r, i)), Tn(Si(e, t.sourceId), a);
          }
          return e;
      ...
      case "RESET_EVENTS":
        return t.eventStore;
      case "MERGE_EVENTS":
        return Tn(e, t.eventStore);
      case "PREV":
      case "NEXT":
      case "CHANGE_DATE":
      case "CHANGE_VIEW_TYPE":
        return r ? Tt(e, r.activeRange, o) : e;
      case "REMOVE_EVENTS":
        return (function (e, t) {
          var n = e.defs,
            r = e.instances,
  ...
  function Ri(e, t, n, r, o) {
    ...
    return {
      headerToolbar: e.headerToolbar
        ? wi(e.headerToolbar, e, t, n, r, o, i)
        : null,
      footerToolbar: e.footerToolbar
        ? wi(e.footerToolbar, e, t, n, r, o, i)
        : null,
      viewsWithButtons: i,
    };
  }
      ...
      eventSourceDefs: [
        {
          ...
          fetch: function (e, t, n) {
            ...
            So(
              e.eventSource.meta.bind(null, gr(e.range, r)),
              function (e) {
                t({ rawEvents: e });
              },
              n
    ...
    Go({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, gr(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
    ...
    Ni = (function () {
      function e(e, t) {
        (this.runTaskOption = e),
          ...
          (this.queue = []),
          (this.delayedRunner = new Ii(this.drain.bind(this)));
      }
      return (
        ...
        dn(
          t.titleFormat ||
            (function (e) {
              ...
              var n = ot(e.currentRange.start, e.currentRange.end);
              if (null !== n && n > 1)
  ...
  var Oi = (function () {
    function e(e) {
      var t = this;
      (this.computeOptionsData = Yt(this._computeOptionsData)),
        (this.computeCurrentViewData = Yt(this._computeCurrentViewData)),
        (this.organizeRawLocales = Yt(Vr)),
        (this.buildLocale = Yt(Fr)),
        (this.buildPluginHooks = jo()),
        (this.buildDateEnv = Yt(Ai)),
        (this.buildTheme = Yt(Wi)),
        (this.parseToolbars = Yt(Ri)),
        (this.buildViewSpecs = Yt(ii)),
        (this.buildDateProfileGenerator = Zt(Li)),
        (this.buildViewApi = Yt(Ui)),
        (this.buildViewUiProps = Zt(Vi)),
        (this.buildEventUiBySource = Yt(Bi, Ct)),
        (this.buildEventUiBases = Yt(zi)),
        (this.parseContextBusinessHours = Zt(Gi)),
        (this.buildTitle = Yt(Hi)),
        (this.emitter = new Eo()),
        (this.actionRunner = new Ni(
      ...
      $n(d.activeRange, c) || (c = d.currentRange.start);
      for (
        var p = {
            dateEnv: o.dateEnv,
      ...
      for (
        var v = li(o.calendarOptions, d, p),
          g = {
    ...
    return (
      ...
      (e.prototype._handleAction = function (e) {
        ...
        this.data &&
          ...
          ("PREV" !== e.type && "NEXT" !== e.type && $n(p.currentRange, d)) ||
            (d = p.currentRange.start);
        for (
          var f = ui(o.eventSources, e, p, c),
            h = mi(o.eventStore, e, f, p, c),
            v =
              (ci(f) &&
            ...
            E = {
              ...
              eventSelection: Ci(o.eventSelection, e),
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = Sn([fn, e, t]),
          ...
          c = (this.currentCalendarOptionsRefiners = r(
            r(r(r(r({}, pn), hn), vn), u.listenerRefiners),
            u.optionRefiners
          )),
          d = {},
          p = Sn([fn, l, e, t]),
        ...
        for (var m in p)
          "plugins" !== m &&
            (p[m] === h[m] || (gn[m] && m in h && gn[m](h[m], p[m]))
              ? (f[m] = v[m])
              : c[m]
              ? ((f[m] = c[m](p[m])), (g = !0))
              : (d[m] = h[m]));
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        var a = Sn([fn, e.optionDefaults, n, o, e.optionOverrides, i]),
          s = r(
            r(r(r(r(r({}, pn), hn), vn), yn), t.listenerRefiners),
            t.optionRefiners
          ),
          l = {},
  ...
  function Wi(e, t) {
    return new (t.themeClasses[e.themeSystem] || qo)(e);
  }

  function Li(e) {
    return new (e.dateProfileGeneratorClass || si)(e);
  }
  ...
  function Gi(e) {
    return Zr(e.options.businessHours, e);
  }
      ...
      return (
        ...
        (e.prototype.insertEntryAt = function (e, t) {
          var n = this.entriesByLevel,
            r = this.levelCoords;
          -1 === t.lateral
            ? (ea(r, t.level, t.levelCoord), ea(n, t.level, [e]))
            : ea(n[t.level], t.lateral, e),
            (this.stackCnts[Ki(e)] = t.stackCnt);
        }),
        (e.prototype.findInsertion = function (e) {
          ...
          var E = -1;
          return (
            S < a && n[S] === s && (E = ta(r[S], e.span.end, Xi)[0]),
            {
              touchingLevel: l,
              touchingLateral: u,
              touchingEntry: c,
  ...
  var ia = {},
    ...
    sa = {},
    la = { startTime: Mt, duration: Mt, create: Boolean, sourceId: String };
  ...
  var ca = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ("title" === c)
              (a = !1),
                i.push(_o("h2", { className: "fc-toolbar-title" }, t.title));
            else {
          ...
          if (i.length > 1) {
            ...
            return _o.apply(void 0, o(["div", { className: m }], i));
          }
          return i[0];
        }),
        t
    ...
    fa = (function (e) {
      function t(t) {
        ...
        return (
          ...
          (n.destroy = Pe(t.el, "click", ".fc-event", n.handleSegClick)),
          n
        );
      }
      return n(t, e), t;
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          (t && !r.isValidSegDownEl(t.target)) ||
            o.emitter.trigger(e, {
              el: n,
              event: new Pr(o, i.eventRange.def, i.eventRange.instance),
              jsEvent: t,
              view: o.viewApi,
            });
        }),
    ...
    va = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildViewContext = Yt(Wo)),
          (t.buildViewPropTransformers = Yt(ma)),
          (t.buildToolbarProps = Yt(ga)),
          (t.handleNavLinkClick = Me(
            "a[data-navlink]",
          ...
          (t.registerInteractiveComponent = function (e, n) {
            ...
            (t.interactionsStore[e.uid] = o), (ia[e.uid] = r);
          }),
          (t.unregisterInteractiveComponent = function (e) {
            for (var n = 0, r = t.interactionsStore[e.uid]; n < r.length; n++) {
              r[n].destroy();
            }
            delete t.interactionsStore[e.uid], delete ia[e.uid];
          }),
          (t.resizeRunner = new Ii(function () {
  ...
  function ga(e, t, n, r, o, i) {
    ...
    return {
      title: i,
      activeButton: e.type,
      isTodayEnabled: a.isValid && !$n(t.currentRange, o),
  ...
  var ya = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return to() || i.push("fc-liquid-hack"), e.children(i, o, r, n);
      }),
      (t.prototype.componentDidMount = function () {
                ...
                r(
                  {
                    ...
                    "data-date": u.isDisabled ? void 0 : Vt(s),
                    colSpan: a.colSpan,
                  },
                  a.extraDataAttrs
                ),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            u = [Ea].concat(ao(l, o), e.extraClassNames || []),
  ...
  var Ta = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.createDayHeaderFormatter = Yt(_a)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
        ...
        return _o(Ra, { unit: "day" }, function (e, t) {
          return _o(
            "tr",
            null,
            i && i("day"),
  ...
  var xa = (function () {
      ...
      return (
        ...
        (e.prototype.getDateDayIndex = function (e) {
          var t = this.indices,
            n = Math.floor(tt(this.dates[0], e));
    ...
    Ma = (function () {
      function e() {
        (this.sliceBusinessHours = Yt(this._sliceBusinessHours)),
          (this.sliceDateSelection = Yt(this._sliceDateSpan)),
          (this.sliceEventStore = Yt(this._sliceEventStore)),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: Qe(e, 1) }, allDay: !1 }, {}, t], n)
          );
        }),
        ...
        (e.prototype._sliceInteraction = function (e, t, n, r) {
          for (var o = [], i = 4; i < arguments.length; i++)
            o[i - 4] = arguments[i];
          if (!e) return null;
          var a = Jn(e.mutatedEvents, t, Pa(n, Boolean(r)), r);
          return {
  ...
  function Pa(e, t) {
    ...
    return t
      ? n
      : {
          start: Qe(n.start, e.slotMinTime.milliseconds),
          end: Qe(n.end, e.slotMaxTime.milliseconds - 864e5),
        };
  }

  function Ia(e, t, n) {
    var r = e.mutatedEvents.instances;
    for (var o in r) if (!Kn(t.validRange, r[o].range)) return !1;
    return Ha({ eventDrag: e }, n);
  }

  function Na(e, t, n) {
    return !!Kn(t.validRange, e.range) && Ha({ dateSelection: e }, n);
  }
  ...
  function Ha(e, t) {
    ...
    return (t.pluginHooks.isPropsValid || Oa)(o, t);
  }
      ...
      !(
        ...
        !(function (e, t, n, o) {
          var i = t.getCurrentData(),
            ...
            l = s.defs,
            u = s.instances,
            c = nr(l, a.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          o && (c = yt(c, o));
          var d =
              ((v = e.eventStore),
              ...
              {
                defs: v.defs,
                instances: mt(v.instances, function (e) {
                  return !g[e.instanceId];
                }),
              }),
            p = d.defs,
            f = d.instances,
            h = nr(p, e.eventUiBases);
          var v, g;
          for (var m in u) {
            var y = u[m],
              S = y.range,
              E = c[y.defId],
              C = l[y.defId];
            if (!Aa(E.constraints, S, d, e.businessHours, t)) return !1;
            ...
            for (var R in f) {
              ...
              if (Xn(S, w.range)) {
                ...
                if (D && !D(new Pr(t, p[w.defId], w), new Pr(t, C, y)))
                  return !1;
              }
            }
            for (var T = i.eventStore, _ = 0, x = E.allows; _ < x.length; _++) {
              var k = x[_],
                M = r(r({}, n), { range: y.range, allDay: C.allDay }),
                P = T.defs[C.defId],
                I = T.instances[m],
                N = void 0;
              if (((N = P ? new Pr(t, P, I) : new Pr(t, C)), !k(Er(M, t), N)))
                return !1;
            }
          }
          return !0;
          ...
          !(function (e, t, n, o) {
            ...
            for (var f in s) {
              ...
              if (Xn(u, h.range)) {
                ...
                if (p && !p(new Pr(t, a[h.defId], h), null)) return !1;
              }
            }
            for (var v = 0, g = c.allows; v < g.length; v++) {
              if (!(0, g[v])(Er(r(r({}, n), l), t), null)) return !1;
            }
            return !0;
          })(e, t, n, o)
        )
  ...
  function Aa(e, t, n, r, o) {
    for (var i = 0, a = e; i < a.length; i++) {
      if (!Ua(Wa(a[i], t, n, r, o), t)) return !1;
    }
    return !0;
  }
  ...
  function ja(e, t) {
    return null != t.maxHeight || Ga(e, t);
  }
    ...
    for (var n = [], r = 0, i = e; r < i.length; r++)
      for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
        n.push(
          _o("col", {
            style: {
              width: "shrink" === a.width ? Xa(t) : a.width || "",
              minWidth: a.minWidth || "",
            },
          })
        );
  ...
  var ns = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.processCols = Yt(function (e) {
          return e;
        }, Ya)),
        (t.renderMicroColGroup = Yt(Za)),
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return _o(
          ...
          Boolean(!v && p.length) && _o.apply(void 0, o(["thead", {}], p)),
          Boolean(!v && f.length) && _o.apply(void 0, o(["tbody", {}], f)),
          Boolean(!v && h.length) && _o.apply(void 0, o(["tfoot", {}], h)),
          v && _o.apply(void 0, o(o(o(["tbody", {}], p), f), h))
        );
      }),
      (t.prototype.renderSection = function (e, t) {
        return "outerContent" in e
          ? _o(Mo, { key: e.key }, e.outerContent)
          : _o(
              "tr",
              { key: e.key, className: Ja(e, this.props.liquid).join(" ") },
      ...
      (t.prototype.computeShrinkWidth = function () {
        return Ka(this.props.cols) ? Fa(this.scrollerElRefs.getAll()) : 0;
      }),
  ...
  ns.addStateEquality({ scrollerClientWidths: Ct, scrollerClientHeights: Ct });
  var rs = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = ko()), t;
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            i = o.ui,
            a = {
              event: new Pr(t, o.def, o.instance),
              view: t.viewApi,
              timeText: e.timeText,
              textColor: i.textColor,
              backgroundColor: i.backgroundColor,
              borderColor: i.borderColor,
              isDraggable: !e.disableDragging && ar(r, t),
              isStartResizable: !e.disableResizing && sr(r, t),
              isEndResizable: !e.disableResizing && lr(r),
              isMirror: Boolean(
        ...
        (t.prototype.componentDidMount = function () {
          er(this.elRef.current, this.props.seg);
        }),
        (t.prototype.componentDidUpdate = function (e) {
          var t = this.props.seg;
          t !== e.seg && er(this.elRef.current, t);
        }),
        t
      );
    })(Uo),
        ...
        (t.prototype.render = function () {
          ...
          return _o(
            rs,
            {
              ...
              defaultContent: e.defaultContent || is,
    ...
    return _o(
      ...
      _o(
        ...
        _o(
          ...
          e.event.title || _o(Mo, null, " ")
        )
      )
    );
  }
  var as = function (e) {
      return _o(Ao.Consumer, null, function (t) {
        var n = t.options,
          r = {
            isAxis: e.isAxis,
  ...
  function us(e) {
    var t = e.date,
      n = e.dateEnv,
      o = io(t, e.todayRange, null, e.dateProfile);
    return r(
      r(r({ date: n.toDate(t), view: e.viewApi }, o), {
        dayNumberText: e.showDayNumber ? n.format(t, ss) : "",
      }),
      e.extraProps
    );
  }
  var cs = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.refineHookProps = Zt(us)), (t.normalizeClassNames = Qo()), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
      ...
      return (
          ...
          return Io(
            _o(
              ...
              _o(
                ...
                _o("span", { className: "fc-popover-title" }, t.title),
                _o("span", {
        ...
        (t.prototype.updateSize = function () {
          var e = this.context.isRtl,
            ...
            i = (function (e) {
              for (
                var t = yo(e), n = e.getBoundingClientRect(), r = 0, o = t;
                r < o.length;
                r++
              ) {
                var i = Kr(n, o[r].getBoundingClientRect());
                if (!i) return null;
                n = i;
              }
              return n;
          ...
          if (i) {
            var a = o.getBoundingClientRect(),
              s = r
                ? Ee(n, ".fc-scrollgrid").getBoundingClientRect().top
                : i.top,
      ...
      return (
        ...
        (t.prototype.updateParentEl = function () {
          this.linkElRef.current &&
            (this.parentEl = Ee(this.linkElRef.current, ".fc-view-harness"));
        }),
        t
      );
    })(Uo);
  ...
  function Es(e) {
    ...
    var t,
      n = e.hiddenSegs;
    return { start: Cs(n), end: ((t = n), t.reduce(Ds).eventRange.range.end) };
  }
  ...
  var Rs = (function (e) {
    function t(t, n) {
      ...
      return (
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    _o(
                      ...
                      _o(va, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
        ...
        (o.el = t),
        (o.renderRunner = new Ii(o.handleRenderRequest)),
        new Oi({
          optionOverrides: n,
          calendarApi: o,
    ...
    return (
      ...
      (t.prototype.updateSize = function () {
        e.prototype.updateSize.call(this), No();
      }),
  ...
  var Ms = (function () {
      ...
      return (
        ...
        (e.prototype.cleanup = function () {
          this.mirrorEl && (Se(this.mirrorEl), (this.mirrorEl = null)),
            (this.sourceEl = null);
        }),
    ...
    Is = (function (e) {
      ...
      return (
        ...
        (t.prototype.computeClientRect = function () {
          return go(this.scrollController.el);
        }),
        t
      );
    })(Ps),
    Ns = (function (e) {
      function t(t) {
        return e.call(this, new Ro(), t) || this;
      }
      return (
        n(t, e),
        (t.prototype.getEventTarget = function () {
      ...
      return (
        ...
        (e.prototype.buildCaches = function (e) {
          return this.queryScrollEls(e).map(function (e) {
            return e === window ? new Ns(!1) : new Is(e, !1);
          });
        }),
        (e.prototype.queryScrollEls = function (e) {
          for (var t = [], n = 0, r = this.scrollQuery; n < r.length; n++) {
            ...
            "object" == typeof o
              ...
              : t.push.apply(
                  t,
                  Array.prototype.slice.call(xe(e).querySelectorAll(o))
                );
          }
          return t;
        }),
    ...
    Ws = (function () {
      function e(e) {
        (this.origRect = mo(e)),
          (this.scrollCaches = yo(e).map(function (e) {
            return new Is(e, !0);
          }));
      }
      return (
    ...
    return (
      (e.prototype.processFirstCoord = function (e) {
        var t,
          ...
          r = n,
          o = e.subjectEl;
        o instanceof HTMLElement && (r = Jr(r, (t = mo(o))));
      ...
      (e.prototype.prepareHits = function () {
        this.offsetTrackers = yt(this.droppableStore, function (e) {
        ...
        for (var i in n) {
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              v &&
                Kn(v.dateProfile.activeRange, v.dateSpan.range) &&
                (!o || v.layer > o.layer) &&
                ((v.componentId = i),
                (v.context = a.context),
                (v.rect.left += l),
  ...
  function Us(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && vr(e.dateSpan, t.dateSpan))
    );
  }
  ...
  var zs = (function (e) {
      function t(t) {
        ...
        var o = (n.hitDragging = new Ls(n.dragging, oa(t)));
        return (
      ...
      function t(t) {
        ...
        (n.dragSelection = null),
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            if (e) {
              ...
              (e.componentId === s.componentId &&
                ...
                (i && Na(i, e.dateProfile, o)) || ((a = !0), (i = null));
            }
            i
          ...
          (n.handlePointerUp = function (e) {
            n.dragSelection &&
              (Sr(n.dragSelection, e, n.component.context),
              (n.dragSelection = null));
          });
        ...
        var a = (n.hitDragging = new Ls(n.dragging, oa(t)));
        return (
    ...
    function t(n) {
      ...
      (o.subjectEl = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          var u = (o.subjectSeg = tr(e.subjectEl)),
            c = (o.eventRange = u.eventRange).instance.instanceId;
          (o.relevantEvents = Rn(l.getCurrentData().eventStore, c)),
          ...
          e.isTouch
            ...
            o.isDragging &&
              ...
              t.emitter.trigger("eventDragStart", {
                el: o.subjectEl,
                event: new Pr(t, n.def, n.instance),
                jsEvent: e.origEvent,
                view: t.viewApi,
              }));
        }),
            ...
            o.displayDrag(a, c),
              ...
              t ||
                ...
                o.dragging.setMirrorIsVisible(
                  !e || !xe(o.subjectEl).querySelector(".fc-event-mirror")
                ),
          ...
          if (o.isDragging) {
            ...
            if (
              ...
              if (a === t) {
                ...
                t.emitter.trigger(
                  "eventLeave",
                  r(r({}, E), { draggedEl: e.subjectEl, view: n })
                ),
      ...
      var s = (o.hitDragging = new Ls(o.dragging, ia));
      return (
        ...
        (n.handleDragStart = function (e) {
          ...
          (n.draggingSegEl = o),
            ...
            t.emitter.trigger("eventResizeStart", {
              el: o,
              event: new Pr(t, r.def, r.instance),
              jsEvent: e.origEvent,
              view: t.viewApi,
            });
        }),
        ...
        (n.handleDragEnd = function (e) {
          ...
          if (
            ...
            t.emitter.trigger(
              ...
              r(r({}, c), {
                el: n.draggingSegEl,
                startDelta: n.validMutation.startDelta || Mt(0),
                endDelta: n.validMutation.endDelta || Mt(0),
                jsEvent: e.origEvent,
                view: t.viewApi,
              })
            ),
  ...
  var js = (function () {
      function e(e) {
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            var n = t.context.options.unselectCancel,
              r = _e(e.origEvent);
            (t.matchesCancel = !!Ee(r, n)),
              (t.matchesEvent = !!Ee(r, Fs.SELECTOR));
          }),
        ...
        var n = (this.documentPointer = new xs(document));
    ...
    Zs = (function () {
      function e(e, t) {
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  var f = t.duration
                      ...
                      : Cr(e.allDay, p, n),
                    h = ht(d.defId, { start: p, end: f });
                  return { def: d, instance: h };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = Dn(s)),
              ...
              if (
                ...
                o.dispatch({ type: "MERGE_EVENTS", eventStore: u }),
                  ...
                  o.emitter.trigger("eventReceive", {
                    event: new Pr(o, i.def, i.instance),
                    relatedEvents: [],
                    revert: function () {
        ...
        var o = (this.hitDragging = new Ls(e, ia));
        (o.requireInitial = !1),
      ...
      return (
        (e.prototype.buildDragMeta = function (e) {
          return "object" == typeof this.suppliedDragMeta
            ? ua(this.suppliedDragMeta)
            : "function" == typeof this.suppliedDragMeta
            ? ua(this.suppliedDragMeta(e))
            : ua(
                (t = (function (e, t) {
        ...
        (e.prototype.canDropElOnCalendar = function (e, t) {
          ...
          return "function" == typeof n
            ...
            : "string" != typeof n || !n || Boolean(Ce(e, n));
        }),
        e
      );
    })();
  ...
  var Xs = (function () {
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay;
            (t.minDistance =
              null != o ? o : e.isTouch ? 0 : fn.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : fn.longPressDelay) : 0);
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
    ...
    Js = Go({
      componentInteractions: [zs, Vs, Fs, Gs],
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            _o(ni, { viewSpec: r.viewSpec }, function (e, t) {
              return _o(
                "div",
          ...
          return (
            ...
            l &&
              u.push({
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "main", content: Qa }],
              }),
            _o(ni, { viewSpec: a.viewSpec }, function (e, t) {
              return _o(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                _o(o, {
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context.options.navLinks
            ? { "data-navlink": lo(e.date), tabIndex: 0 }
            : {};
        return _o(
          ls,
          {
    ...
    ll = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = t.options.eventTimeFormat || il,
            o = ur(e.seg, n, t, !0, e.defaultDisplayEventEnd);
          return _o(
            rs,
            {
              seg: e.seg,
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            s = t.dateProfile,
            l = i.navLinks
              ? { "data-navlink": lo(a, "week"), tabIndex: 0 }
              : {};
          return _o(
            cs,
            {
            ...
            function (e, n, i, u) {
              return _o(
                ...
                _o(
                  ...
                  _o("div", { className: "fc-daygrid-day-bg" }, t.bgContent)
                )
              );
            }
          );
  ...
  function hl(e, t, n, r, o, i, a) {
    ...
    for (
              ...
              (d += y.levelCoord - c),
                ...
                S
                  ? ((d += y.thickness),
                    E &&
                      v.push({
                        seg: vl(h, y.span.start, y.span.end, n),
                        isVisible: !0,
                        isAbsolute: !0,
                        absoluteTop: y.levelCoord,
                        marginTop: 0,
      ...
      for (var C = w.firstCol; C <= w.lastCol; C += 1)
        h[C].push({
          seg: vl(w, C, C + 1, a),
          isVisible: !1,
          isAbsolute: !1,
    ...
    for (C = 0; C < a.length; C += 1) m.push(0);
    for (var b = 0, D = p; b < D.length; b++) {
      var R = D[b],
        w = e[R.index],
        T = R.span;
      v[T.start].push({
        seg: vl(w, T.start, T.end, a),
        isVisible: !1,
        isAbsolute: !0,
        absoluteTop: 0,
        marginTop: 0,
      });
      for (C = T.start; C < T.end; C += 1)
        (m[C] += 1),
          h[C].push({
            seg: vl(w, C, C + 1, a),
            isVisible: !1,
    ...
    for (C = 0; C < a.length; C += 1) y.push(g[C]);
    return {
  ...
  function vl(e, t, n, o) {
    ...
    var i = e.eventRange,
      a = i.range,
      s = Yn(a, { start: o[t].date, end: Je(o[n - 1].date, 1) });
    return r(r({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
          ...
          if (this.hiddenConsumes && s) {
            ...
            if (!a[c])
              if (this.allowReslicing) {
                var d = r(r({}, s), { span: Qi(s.span, n.span) });
                (a[Ki(d)] = !0), (i[l][u] = d), this.splitEntry(s, n, o);
              } else (a[c] = !0), o.push(s);
          }
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            o = t.context.options,
            i = n.cells.length,
            a = tl(n.businessHourSegs, i),
            s = tl(n.bgEventSegs, i),
            l = tl(this.getHighlightSegs(), i),
            u = tl(this.getMirrorSegs(), i),
            c = hl(
              or(n.fgEventSegs, o.eventOrder),
              n.dayMaxEvents,
              n.dayMaxEventRows,
              o.eventOrderStrict,
          ...
          return _o(
            ...
            n.cells.map(function (t, r) {
              ...
              return _o(fl, {
                ...
                fgContent: _o(Mo, null, _o(Mo, null, o), _o(Mo, null, i)),
                bgContent: _o(
                  Mo,
                  null,
        ...
        (t.prototype.renderFgSegs = function (e, t, n, o, i, a, s) {
          ...
          if (c)
            for (var h = 0, v = t; h < v.length; h++) {
              ...
              C &&
                (l.isRtl
                  ? ((D = 0), (b = c.lefts[m.lastCol] - c.lefts[m.firstCol]))
                  : ((b = 0),
                  ...
                  _o(
                    "div",
                    {
                      className:
                        ...
                        (C ? " fc-daygrid-event-harness-abs" : ""),
                      key: S,
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                _o(
                  ...
                  "bg-event" === t ? _o(ps, r({ seg: c }, cr(c, i))) : ds(t)
                )
              );
            }
          return _o.apply(void 0, o([Mo, {}], s));
        }),
  ...
  ml.addStateEquality({ eventInstanceHeights: Ct });
  var yl = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitBusinessHourSegs = Yt(el)),
        (t.splitBgEventSegs = Yt(el)),
        (t.splitFgEventSegs = Yt(el)),
        (t.splitDateSelectionSegs = Yt(el)),
        (t.splitEventDrag = Yt(nl)),
        (t.splitEventResize = Yt(nl)),
        (t.rowRefs = new Va()),
        (t.handleRootEl = function (e) {
          (t.rootEl = e),
            e
      ...
      var r = n.dateEnv,
        ...
        a =
          null == o.slotLabelFormat
            ...
            ? dn(o.slotLabelFormat[0])
            : dn(o.slotLabelFormat),
        s = {
          level: 0,
          time: e.time,
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              s =
                o.navLinks && 1 === a
                  ? { "data-navlink": lo(i.start, "week"), tabIndex: 0 }
                  : {};
                  ...
                  content: function (e) {
                    return _o(
                      ...
                      _o(
                        ...
                        _o(Ra, { unit: h ? "minute" : "day" }, function (e) {
  ...
  var Nl = (function () {
      ...
      return (
        (e.prototype.safeComputeTop = function (e) {
          ...
          if ($n(t.currentRange, e)) {
            ...
            if (r >= Lt(t.slotMinTime) && r < Lt(t.slotMaxTime))
              return this.computeTimeTop(Mt(r));
          }
          return null;
        }),
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = it(e)), this.computeTimeTop(Mt(e.valueOf() - t.valueOf()))
          );
        }),
        (e.prototype.computeTimeTop = function (e) {
          var t,
            ...
            o = this.dateProfile,
            i = r.els.length,
            a = (e.milliseconds - Lt(o.slotMinTime)) / Lt(this.slotDuration);
          return (
            (a = Math.max(0, a)),
            (a = Math.min(i, a)),
            (t = Math.floor(a)),
    ...
    Ol = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.rootElRef = ko()), (t.slatElRefs = new Va()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function zl(e, t) {
    ...
    for (
      ...
      a.push(t(n, i)), (i += 1);
    return a.sort(Vl), [a.map(Fl), a[0][1]];
  }
  ...
  var ql = dn({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    Yl = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
    ...
    Xl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.sortEventSegs = Yt(or)), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
            ...
            i = jl(e, n.date, n.slatCoords, o.options.eventMinHeight).map(
              function (o, i) {
                ...
                return _o(
                  ...
                  "bg-event" === t
                    ? _o(ps, r({ seg: a }, cr(a, n.todayRange, n.nowDate)))
                    : ds(t)
                );
              }
            );
  ...
  var Jl = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitFgEventSegs = Yt(Al)),
        (t.splitBgEventSegs = Yt(Al)),
        (t.splitBusinessHourSegs = Yt(Al)),
        (t.splitNowIndicatorSegs = Yt(Al)),
        (t.splitDateSelectionSegs = Yt(Al)),
        (t.splitEventDrag = Yt(Wl)),
        (t.splitEventResize = Yt(Wl)),
        (t.rootElRef = ko()),
        (t.cellElRefs = new Va()),
        t
      );
      ...
      (t.prototype.queryHit = function (e, t) {
        ...
        if (null != p && null != f) {
          var h = this.props.cells[p],
            ...
            E = Nt(s.slotMinTime, Ht(c, y)),
            C = o.add(S, E),
            b = o.add(C, c);
          return {
            dateProfile: s,
            dateSpan: r(
              { range: { start: C, end: b }, allDay: !1 },
              h.extraDateSpan
            ),
            dayEl: a.els[p],
            rect: {
    ...
    nu = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return _o(Ra, { unit: a ? "minute" : "day" }, function (l, u) {
            return _o(
              Ql,
        ...
        l =
          ...
          (function (e) {
            ...
            for (t = ou.length - 1; t >= 0; t -= 1)
              if (null !== (r = Ut((n = Mt(ou[t])), e)) && r > 1) return n;
            return e;
          })(r),
        u = [];
      Lt(a) < Lt(t);
  ...
  var au = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.buildTimeColsModel = Yt(su)), (t.buildSlatMetas = Yt(iu)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function cu(e) {
    ...
    return _o(
      Mo,
      null,
      e.text && _o("a", r({ className: "fc-list-day-text" }, t), e.text),
      e.sideText &&
        _o("a", r({ className: "fc-list-day-side-text" }, t), e.sideText)
    );
  }
  var du = dn({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
    pu = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = e.seg,
            r = t.options.eventTimeFormat || du;
          return _o(
            rs,
            {
              seg: n,
            ...
            function (e, o, i, a, s) {
              return _o(
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    if (
                      (o.allDay
                        ...
                        ? e.isStart
                          ? (s = ur(e, t, n, null, null, i.range.start, e.end))
                          : e.isEnd
                          ? (s = ur(e, t, n, null, null, e.start, i.range.end))
                          : (a = !0)
                        : (s = ur(e, t, n)),
                      a)
                    ) {
                    ...
                    return _o("td", { className: "fc-list-event-time" }, s);
                  }
                  return null;
                })(n, r, t),
                _o(
                ...
                _o("td", { className: "fc-list-event-title", ref: i }, a)
              );
            }
          );
        }),
  ...
  function fu(e) {
    var t = e.event,
      n = t.url;
    return _o("a", r({}, n ? { href: n } : {}), t.title);
  }
  ...
  var vu = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.computeDateVars = Yt(mu)),
        (t.eventStoreToSegs = Yt(t._eventStoreToSegs)),
    ...
    return (
      ...
      (t.prototype.renderSegList = function (e, t) {
        ...
        return _o(Ra, { unit: "day" }, function (e, n) {
          for (var s = [], l = 0; l < a.length; l += 1) {
            var u = a[l];
            if (u) {
              var c = t[l].toISOString();
              s.push(_o(uu, { key: c, dayDate: t[l], todayRange: n }));
              for (
                var d = 0, p = (u = or(u, i.eventOrder));
                d < p.length;
                d++
              ) {
                var f = p[d];
  ...
  function mu(e) {
    for (
      var t = it(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;
  ...
  var Cu = Go({ themeClasses: { bootstrap: Eu } }),
    bu = "https://www.googleapis.com/calendar/v3/calendars";
  var Du = Go({
      eventSourceDefs: [
        {
          parseMeta: function (e) {
      ...
      viewContainerAppends: [
        function (e) {
          ...
          if (!/\w+:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n)) {
            var r = (function (e) {
              if (-1 !== wu.indexOf(e)) return "valid";
              var t = (e || "").match(/^(\d+)-fcs-(\d+)$/);
              if (t && 10 === t[1].length) {
                var n = new Date(1e3 * parseInt(t[2], 10)),
                  r = new Date(sa.mockSchedulerReleaseDate || Ru);
                if (pt(r)) return Je(r, -372) < n ? "valid" : "valid";
              }
              return "valid";
            })(t);
            if ("valid" !== r)
              return _o(
                "div",
                { className: "fc-license-message", style: Tu },
                "outdated" === r
                  ? _o(
                      Mo,
                      null,
    ...
    Mu = (function () {
      function e(e) {
        ...
        (this.el = e),
          ...
          (this.wheelWaiter = new Ii(this._handleWheelWaited.bind(this))),
          (this.scrollWaiter = new Ii(this._handleScrollWaited.bind(this))),
  ...
  var Hu,
    Ou = "undefined" != typeof navigator && /Edge/.test(navigator.userAgent),
    Au = (function () {
      function e(e, t) {
        var n = this;
        (this.scrollEl = e),
              ...
              ? (function (e, t, n, r, o) {
                  e.forEach(function (e, i) {
                    var a,
                      ...
                      p = c.bottom - c.bottom;
                    d > r || p > o
                      ? ((a = n[i].left - u.left), (s = n[i].top - u.top))
                      : ((a = ""), (s = "")),
                      we(e, {
                        position: "relative",
                        left: a,
      ...
      return (
        ...
        (e.prototype.queryElGeoms = function (e) {
          for (
            var t = this.scrollEl,
              ...
              r = (function (e) {
                var t = e.getBoundingClientRect(),
                  n = vo(e);
                return {
                  left: t.left + n.borderLeft + n.scrollbarLeft - Pu(e),
            ...
            var s = a[i],
              l = $r(go(s.parentNode, !0, !0), -r.left, -r.top),
  ...
  var Wu = (function (e) {
      function t() {
        ...
        return (
          ...
          (t.handleScroller = function (e) {
            (t.scroller = e), Vo(t.props.scrollerRef, e);
          }),
          (t.handleSizing = function () {
            var e = t.props;
            "scroll-hidden" === e.overflowY &&
              t.setState({ yScrollbarWidth: t.scroller.getYScrollbarWidth() }),
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            "scroll-hidden" === t.overflowY &&
              ...
              (r ? (o = n.yScrollbarWidth) : (i = n.yScrollbarWidth)),
            _o(
              "div",
              {
                ref: this.elRef,
                className:
                  "fc-scroller-harness" +
                  (t.liquid ? " fc-scroller-harness-liquid" : ""),
              },
              _o(
                za,
                {
                  ...
                  overflowX:
                    "scroll-hidden" === t.overflowX ? "scroll" : t.overflowX,
                  overflowY:
                    "scroll-hidden" === t.overflowY ? "scroll" : t.overflowY,
                  overcomeLeft: o,
                  overcomeRight: i,
                  overcomeBottom: a,
                  maxHeight:
        ...
        (t.prototype.componentDidUpdate = function (e) {
          Ct(e, this.props) || this.handleSizing();
        }),
        (t.prototype.componentWillUnmount = function () {
          this.context.removeResizeHandler(this.handleSizing);
        }),
    ...
    Uu = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.compileColGroupStats = Xt(Fu, qu)),
          (t.renderMicroColGroups = Xt(Za)),
          (t.clippedScrollerRefs = new Va()),
          (t.scrollerElRefs = new Va(t._handleScrollerEl.bind(t))),
          (t.chunkElRefs = new Va(t._handleChunkEl.bind(t))),
          (t.getStickyScrolling = Xt(Xu, null, Ku)),
          (t.getScrollSyncersBySection = Kt(Yu.bind(t, !0), null, Zu)),
          (t.getScrollSyncersByColumn = Kt(Yu.bind(t, !1), null, Zu)),
          (t.stickyScrollings = []),
          ...
          (t.handleSizing = function (e, n) {
            if (t.allowSizing()) {
              ...
              (e || (!n && !t.rowUnstableMap.size)) &&
                (o.sectionRowMaxHeights = t.computeSectionRowMaxHeights()),
                t.setState(
                  r(
                    r(
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          u[0], u[1];
          for (
            var c, d = t.sections, p = d.length, f = 0, h = [], v = [], g = [];
            f < p && "header" === (c = d[f]).type;

          )
            h.push(this.renderSection(c, f, a, s, n.sectionRowMaxHeights)),
              (f += 1);
          for (; f < p && "body" === (c = d[f]).type; )
            v.push(this.renderSection(c, f, a, s, n.sectionRowMaxHeights)),
              (f += 1);
          for (; f < p && "footer" === (c = d[f]).type; )
            g.push(this.renderSection(c, f, a, s, n.sectionRowMaxHeights)),
              (f += 1);
          var m = !to();
          return _o(
            "table",
            ...
            (function (e, t) {
              var n = e.map(function (e, n) {
                var r = e.width;
                return (
                  "shrink" === r && (r = e.totalColWidth + Xa(t[n]) + 1),
                  _o("col", { style: { width: r } })
                );
              });
              return _o.apply(void 0, o(["colgroup", {}], n));
            })(a, i),
            Boolean(!m && h.length) && _o.apply(void 0, o(["thead", {}], h)),
            Boolean(!m && v.length) && _o.apply(void 0, o(["tbody", {}], v)),
            Boolean(!m && g.length) && _o.apply(void 0, o(["tfoot", {}], g)),
            m && _o.apply(void 0, o(o(o(["tbody", {}], h), v), g))
          );
        }),
        ...
        (t.prototype.renderChunk = function (e, t, n, r, o, i, a) {
          if ("outerContent" in o)
            return _o(Mo, { key: o.key }, o.outerContent);
          var s = this.state,
            ...
            p = c[1],
            f = t * p + i,
            h = i === (!this.context.isRtl || po() ? p - 1 : 0),
            v = t === d - 1,
          ...
          return (
            ...
            _o("td", { key: o.key, ref: this.chunkElRefs.createRef(f) }, b)
          );
        }),
        (t.prototype.componentDidMount = function () {
        ...
        (t.prototype.allowSizing = function () {
          ...
          return !this.lastSizingDate ||
            e.valueOf() >
              this.lastSizingDate.valueOf() + sa.SCROLLGRID_RESIZE_INTERVAL
          ...
          for (
            ...
            if (a && a.syncRowHeights) {
              for (var l = [], u = 0; u < r; u += 1) {
                ...
                (d = p
                  ? be(p, ".fc-scrollgrid-sync-table tr").map(function (t) {
                      var n = zu(t);
                      return e.set(t, n), n;
                    })
                  : []),
              ...
              for (u = 1; u < r; u += 1) {
                if (
                  !(a.chunks[u] && void 0 !== a.chunks[u].outerContent) &&
                  l[u].length !== f
                ) {
                  h = !1;
                  break;
          ...
          for (p = 0; p < n; p += 1)
            for (f = 0; f < r; f += 1) {
              ...
              if (g) {
                var m = g.parentNode;
                (c[v] = Math.floor(
                  m.getBoundingClientRect().width - (f === o && l ? e.y : 0)
                )),
                  (d[v] = Math.floor(
                    m.getBoundingClientRect().height - (p === i && u ? e.x : 0)
                  ));
              }
            }
          return {
        ...
        (t.prototype.destroyStickyScrolling = function () {
          this.stickyScrollings.forEach(Ku);
        }),
        ...
        (t.prototype.destroyScrollSyncers = function () {
          yt(this.scrollSyncersBySection, Zu),
            yt(this.scrollSyncersByColumn, Zu);
        }),
  ...
  function zu(e) {
    var t = be(e, ".fc-scrollgrid-sync-inner").map(Vu);
  ...
  function Fu(e) {
    var t = Gu(e.cols, "width"),
      n = Gu(e.cols, "minWidth"),
      r = Ka(e.cols);
    return {
      hasShrinkCol: r,
      totalColWidth: t,
  ...
  Uu.addStateEquality({
    shrinkWidths: qt,
    scrollerClientWidths: Ct,
    scrollerClientHeights: Ct,
  });
  var ju = { cols: Ya };
  ...
  var $u = Go({ deps: [xu], scrollGridImpl: Uu });
  (sa.SCROLLGRID_RESIZE_INTERVAL = 500),
    (sa.COLLAPSIBLE_WIDTH_THRESHOLD = 1200);
  var Ju = [],
    Qu = [],
    ec = Go({
      deps: [xu],
      contextInit: function (e) {
        Ju.length ||
          (window.addEventListener("beforeprint", tc),
          window.addEventListener("afterprint", nc)),
          Ju.push(e),
          e.calendarApi.on("_unmount", function () {
            jt(Ju, e),
              Ju.length ||
                (window.removeEventListener("beforeprint", tc),
                window.removeEventListener("afterprint", nc));
          });
      },
    });
  ...
  function tc() {
    for (
      var e = be(document.body, ".fc-scroller-harness > .fc-scroller"),
        t = e.map(function (e) {
    ...
    No(),
      ...
      Qu.push(
        (function () {
          var e = be(document.body, ".fc-scrollgrid");
          return (
            e.forEach(rc),
            function () {
              return e.forEach(oc);
  ...
  function ac(e, t, n, r) {
    ...
    !(function (e, t, n) {
      ...
      if (e.labelInterval && e.slotDuration) {
        var o = Ut(e.labelInterval, e.slotDuration);
        (null === o || o < 1) &&
      ...
      (function (e, t, n) {
        var r = t.currentRange,
          o = e.slotDuration;
        if (!o) {
          for (var i = uc(e, t, n), a = 0, s = ic; a < s.length; a++) {
            var l = Mt(s[a]),
              u = Ut(i, l);
            if (null !== u && u > 1 && u <= 6) {
              o = l;
    ...
    var s = null;
    if (!o.isTimeScale) {
      var l = Bt(o.slotDuration).unit;
      /year|month|week/.test(l) && (s = l);
    }
    (o.largeUnit = s),
      (o.emphasizeWeeks =
        1 === It(o.slotDuration) && cc("weeks", e, t) >= 2 && !n.businessHours);
    var u,
      c,
      d = n.snapDuration;
    d && ((u = Mt(d)), (c = Ut(o.slotDuration, u))),
      null == c && ((u = o.slotDuration), (c = 1)),
      (o.snapDuration = u),
      (o.snapsPerSlot = c);
    var p = Lt(e.slotMaxTime) - Lt(e.slotMinTime),
      f = sc(e.renderRange.start, o, t),
      h = sc(e.renderRange.end, o, t);
    o.isTimeScale &&
      ((f = t.add(f, e.slotMinTime)), (h = t.add(Je(h, -1), e.slotMaxTime))),
      (o.timeWindowMs = p),
      (o.normalizedRange = { start: f, end: h });
    for (var v = [], g = f; g < h; )
      lc(g, o, e, r) && v.push(g), (g = t.add(g, o.slotDuration));
    o.slotDates = v;
    var m = -1,
      y = 0,
      S = [],
      E = [];
    for (g = f; g < h; )
      lc(g, o, e, r) ? ((m += 1), S.push(m), E.push(y)) : S.push(m + 0.5),
      ...
      (o.cellRows = (function (e, t) {
        for (
          ...
          for (
            ...
            if (g) {
              var S = t.format(u, p);
              h && h.text === S ? (h.colspan += 1) : (m = dc(u, S, y));
            } else if (
              !h ||
              Ze(
              ...
              m = dc(u, (S = t.format(u, p)), y);
            } else h.colspan += 1;
            m && ((m.weekStart = c), f.push(m));
          }
        return o;
      })(o, t)),
      (o.slotsPerLabel = Ut(o.labelInterval, o.slotDuration)),
      o
    );
  }
  ...
  function sc(e, t, n) {
    ...
    return (
      t.isTimeScale ||
        ((r = it(r)), t.largeUnit && (r = n.startOf(r, t.largeUnit))),
      r
    );
  }
  ...
  function lc(e, t, n, r) {
    ...
    if (t.isTimeScale) {
      var o = it(e),
        i = e.valueOf() - o.valueOf() - Lt(n.slotMinTime);
  ...
  function uc(e, t, n) {
    ...
    if (!o) {
      if (e.slotDuration) {
        for (var i = 0, a = ic; i < a.length; i++) {
          var s = Mt(a[i]),
            l = Ut(s, e.slotDuration);
          if (null !== l && l <= 6) {
            o = s;
            break;
          }
        ...
        for (var u = 0, c = ic; u < c.length; u++) {
          if (
            ((o = Mt(c[u])), n.countDurationsBetween(r.start, r.end, o) >= 18)
          )
            break;
        }
      e.labelInterval = o;
  ...
  var vc = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.refineHookProps = Zt(hc)), (t.normalizeClassNames = Qo()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
          var e = this.props,
            ...
            i = e.dateProfile,
            a = e.tDateProfile,
            s = io(o.date, e.todayRange, e.nowDate, i),
            l = ["fc-timeline-slot", "fc-timeline-slot-label"].concat(
              "time" === o.rowUnit ? so(s, t.theme) : ao(s, t.theme)
            );
            ...
            function (t) {
              return _o(
                ...
                _o(
                  ...
                  _o(pc, { hookProps: c, isSticky: e.isSticky, navLinkData: u })
                )
              );
            }
          );
              ...
              return _o(
                "tr",
                {
                  ...
                  className: [
                    ...
                    u ? "fc-timeline-header-row-chrono" : "",
                  ].join(" "),
                },
                e.map(function (e) {
                  return _o(vc, {
    ...
    mc = (function () {
      function e(e, t, n, r, o, i) {
        (this.slatRootEl = e),
          ...
          (this.dateEnv = o),
          (this.isRtl = i),
          (this.outerCoordCache = new Co(e, t, !0, !1)),
          (this.innerCoordCache = new Co(e, De(t, "div"), !0, !1));
      }
      return (
        (e.prototype.isDateInRange = function (e) {
          return $n(this.dateProfile.currentRange, e);
        }),
        ...
        (e.prototype.computeDateSnapCoverage = function (e) {
          return yc(e, this.tDateProfile, this.dateEnv);
        }),
        e
      );
    })();
  ...
  function yc(e, t, n) {
    ...
    return Ze(i) ? (i += r - o) : (i = Math.ceil(i)), i;
  }
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            t = this.props,
            n = this.context,
            r = Bt(t.tDateProfile.slotDuration).unit,
            o =
              t.slatCoords && t.slatCoords.dateProfile === t.dateProfile
                ? t.slatCoords
                : null;
          return _o(Ra, { unit: r }, function (r, i) {
            return _o(
              "div",
              ...
              n.options.nowIndicator &&
                _o(
                  ...
                  o &&
                    o.isDateInRange(r) &&
                    _o(as, { isAxis: !0, date: r }, function (e, t, i, a) {
                      return _o(
                        "div",
                        {
                          ref: e,
                          className: ["fc-timeline-now-indicator-arrow"]
                            .concat(t)
                            .join(" "),
                          style: Sc(o.dateToCoord(r), n.isRtl),
                        },
                        a
                      );
                    })
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            s = e.tDateProfile,
            l = e.isEm,
            u = io(e.date, e.todayRange, e.nowDate, e.dateProfile),
          ...
          return (
            ...
            c.push.apply(c, e.isDay ? ao(u, i) : so(u, i)),
            _o(
              Zo,
              {
                hookProps: p,
              ...
              function (e, t, n, o) {
                return _o(
                  "td",
                  r({ ref: e, className: c.concat(t).join(" ") }, d),
                  _o("div", { ref: n }, o)
                );
              }
            )
        ...
        (t.prototype.positionToHit = function (e) {
          ...
          if (null != a) {
            var s = t.getWidth(a),
              ...
              c = r.add(i.slotDates[a], Ht(i.snapDuration, u));
            return {
              dateSpan: {
                range: { start: c, end: r.add(c, i.snapDuration) },
  ...
  var Tc = (function (e) {
          ...
          var o = this.props,
            ...
            u = e.map(function (e, t) {
              ...
              return _o(
                ...
                "bg-event" === n ? _o(ps, r({ seg: e }, cr(e, i, a))) : ds(n)
              );
            });
          return _o(Mo, null, u);
        }),
      ...
      return (
        ...
        (t.prototype.sliceRange = function (e, t, n, r, o) {
          var i = (function (e, t, n) {
            ...
            a = [];
          if (yc(i.start, r, o) < yc(i.end, r, o)) {
          ...
          return _o(
            ...
            function (t, n, o, a, s) {
              return _o(
                ...
                {
                  ref: function (n) {
                    Vo(t, n), Vo(i, n), Vo(e.rootElRef, n);
                  },
                  className: ["fc-timeline-more-link"].concat(n).join(" "),
                  style: r({ visibility: c ? "" : "hidden", top: l || 0 }, d),
                  onClick: s,
                },
                _o(
                  "div",
    ...
    Pc = (function (e) {
      function t() {
        ...
        return (
          (t.slicer = new _c()),
          (t.sortEventSegs = Yt(or)),
          (t.harnessElRefs = new Va()),
          (t.moreElRefs = new Va()),
          (t.innerElRef = ko()),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            c = (function (e, t, n, r, o, i) {
              for (var a = [], s = [], l = 0; l < e.length; l += 1) {
                var u = e[l],
                  ...
                  d = t[l];
                c && d
                  ? a.push({ index: l, span: d, thickness: c })
              ...
              for (l = 0; l < v.length; l += 1) {
                var S = v[l],
                  E = S.entries.map(y);
                null != (c = r[zt(Cs(E))])
                  ? g.push({ index: e.length + l, thickness: c, span: S.span })
                  : m.push({ seg: E, hcoords: S.span, top: null });
              }
              (p.maxStackCnt = -1), p.addSegs(g);
              for (
                var C = [], b = 0, D = 0, R = p.toRects();
                D < R.length;
                D++
              ) {
                var w = R[D],
                ...
                C.push({
                  ...
                  (b = Math.max(b, w.levelCoord + w.thickness));
              }
              return [C.concat(s, h, m), b];
            })(
              u,
              wc(u, o.eventMinWidth, t.timelineCoords),
            ...
            p = c[1],
            f =
              (s.eventDrag ? s.eventDrag.affectedInstances : null) ||
              ...
              this.setState(
                {
                  ...
                  moreLinkHeights: yt(this.moreElRefs.currentMap, function (e) {
                    return Math.round(e.getBoundingClientRect().height);
                  }),
                },
                function () {
            ...
            e.map(function (e) {
              ...
              return _o(
                "div",
                {
                  ...
                  style: r({ visibility: g ? "" : "hidden", top: f || 0 }, m),
                },
                _o(
                  kc,
                  r(
  ...
  Pc.addStateEquality({ eventInstanceHeights: Ct, moreLinkHeights: Ct });
  var Ic = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
              ...
              return _o(
                ...
                i.nowIndicator &&
                  ...
                  _o(
                    "div",
                    { className: "fc-timeline-now-indicator-container" },
                    _o(as, { isAxis: !1, date: t }, function (e, n, i, a) {
                      return _o(
                        "div",
                        {
                          ref: e,
                          className: ["fc-timeline-now-indicator-line"]
                            .concat(n)
                            .join(" "),
                          style: Sc(r.coords.dateToCoord(t), o.isRtl),
                        },
                        a
                      );
                    })
    ...
    Nc = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.buildTimelineDateProfile = Yt(ac)),
          (t.scrollGridRef = ko()),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            c = [
              "fc-timeline",
              !1 === a.eventOverlap ? "fc-timeline-overlap-disabled" : "",
            ],
            d = a.slotMinWidth,
            p = Hc(u, d || this.computeFallbackSlotMinWidth(u)),
            f = [
              {
                type: "header",
                key: "header",
          ...
          return (
            l &&
              f.push({
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "timeline", content: Qa }],
              }),
            _o(ni, { viewSpec: i.viewSpec }, function (t, r) {
              return _o(
                "div",
      ...
      return (
        r(
          ...
          (function (e, t) {
            var n = {};
            for (var r in e)
              for (var o = void 0; (o = t[r]) && (r = o.parentId); ) n[r] = !0;
            return n;
          })(i, e)
        ),
        mt(e, function (e, t) {
  ...
  var Uc = (function () {
    function e() {
      (this.buildResourceEventUis = Yt(Bc, Ct)),
        (this.injectResourceEventUis = Yt(zc));
    }
    return (
      (e.prototype.transform = function (e, t) {
        return t.viewSpec.optionDefaults.needsResourceData
  ...
  function Yc(e) {
    ...
    if (
      ...
      var o = (function (e) {
        for (var t = jc(), n = t.length - 1; n >= 0; n -= 1) {
      ...
      case "CHANGE_VIEW_TYPE":
        return (function (e, t, n, r) {
          if (
            n &&
            !(function (e) {
              return Boolean(Gc(e.sourceDefId).ignoreRange);
            })(e) &&
            (!e.fetchRange || !Zn(e.fetchRange, t))
          )
            return Kc(e, t, r);
          return e;
  ...
  function Xc(e, t, n, r) {
    if (e) {
      var o = Yc(e);
      return (o = Kc(o, n ? t : null, r));
    }
    return null;
  }

  function Kc(e, t, n) {
    var o = Gc(e.sourceDefId),
      i = Oe();
    return (
      o.fetch(
  ...
  function Qc(e, t, n, o) {
    ...
    var i = En(e, Jc),
      ...
      l = {
        ...
        title: a.title || "",
        businessHours: a.businessHours ? Zr(a.businessHours, o) : null,
        ui: Pn(
          {
    ...
    if (
      (Object.freeze(l.ui.classNames), Object.freeze(l.extendedProps), n[l.id])
    );
      ...
      case "REMOVE_RESOURCE":
        return (function (e, t) {
          ...
          for (var o in (delete n[t], n))
            n[o].parentId === t && (n[o] = r(r({}, n[o]), { parentId: "" }));
          return n;
        })(e, t.resourceId);
  ...
  var nd = { resourceId: String, resourceIds: Cn, resourceEditable: Boolean };
  var rd = (function () {
    function e(e, t) {
    ...
    return (
      ...
      (e.prototype.getEvents = function () {
        ...
        for (var a in o) {
          var s = o[a],
            l = r[s.defId];
          -1 !== l.resourceIds.indexOf(e) && i.push(new Pr(t, l, s));
        }
        return i;
      }),
      Object.defineProperty(e.prototype, "id", {
        get: function () {
          return ed(this._resource.id);
        },
        enumerable: !1,
        configurable: !0,
      }),
  ...
  (Mr.prototype.addResource = function (e, t) {
    var n,
      r = this;
    void 0 === t && (t = !0);
    var o,
    ...
    (Mr.prototype.getResourceById = function (e) {
      e = String(e);
      var t = this.getCurrentData();
      if (t.resourceStore) {
        var n = t.resourceStore[e];
        if (n) return new rd(t, n);
      }
      return null;
    }),
    (Mr.prototype.getResources = function () {
      var e = this.getCurrentData(),
        t = e.resourceStore,
        n = [];
      if (t) for (var r in t) n.push(new rd(e, t[r]));
      return n;
    }),
    (Mr.prototype.getTopLevelResources = function () {
      var e = this.getCurrentData(),
        t = e.resourceStore,
        n = [];
      if (t) for (var r in t) t[r].parentId || n.push(new rd(e, t[r]));
      return n;
    }),
    (Mr.prototype.refetchResources = function () {
  ...
  function id(e, t) {
    return r(r({}, t), { constraints: ad(e, t.constraints) });
  }
  ...
  var ud = {
      ...
      resourceAreaWidth: Cn,
      resourceAreaColumns: Cn,
      resourcesInitiallyExpanded: Boolean,
      datesAboveResources: Boolean,
      needsResourceData: Boolean,
      resourceAreaHeaderClassNames: Cn,
      resourceAreaHeaderContent: Cn,
      resourceAreaHeaderDidMount: Cn,
      resourceAreaHeaderWillUnmount: Cn,
      resourceGroupLabelClassNames: Cn,
      resourceGroupLabelContent: Cn,
      resourceGroupLabelDidMount: Cn,
      resourceGroupLabelWillUnmount: Cn,
      resourceLabelClassNames: Cn,
      resourceLabelContent: Cn,
      resourceLabelDidMount: Cn,
      resourceLabelWillUnmount: Cn,
      resourceLaneClassNames: Cn,
      resourceLaneContent: Cn,
      resourceLaneDidMount: Cn,
      resourceLaneWillUnmount: Cn,
      resourceGroupLaneClassNames: Cn,
      resourceGroupLaneContent: Cn,
      resourceGroupLaneDidMount: Cn,
      resourceGroupLaneWillUnmount: Cn,
    },
    cd = {
      resourcesSet: Cn,
      resourceAdd: Cn,
  ...
  var fd = (function (e) {
            ...
            function (t, n, o, i, a) {
              return _o(
                ...
                r(
                  {
                    ref: t,
                    className: ["fc-col-header-cell", "fc-resource"]
                      .concat(n)
                      .join(" "),
                    colSpan: e.colSpan,
                  },
    ...
    hd = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.buildDateFormat = Yt(vd)), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
          ...
          return _o(Ra, { unit: "day" }, function (o, i) {
        ...
        (t.prototype.renderResourceRow = function (e, t) {
          var n = e.map(function (e) {
            return _o(fd, { key: e.id, resource: e, colSpan: 1, date: t });
          });
        ...
        (t.prototype.renderDateCell = function (e, t, n, r, o, i) {
          var a = this.props,
            s = o ? ":" + o.id : "",
            l = o ? { resource: new rd(this.context, o) } : {},
  ...
  var gd = function (e) {
          ...
          for (
            ...
            for (var a = [], s = 0; s < n.colCnt; s += 1)
              for (var l = 0; l < r.length; l += 1) {
                var u = r[l],
                  c = { resource: new rd(this.context, u) },
    ...
    Cd = (function () {
      function e() {
        (this.joinDateSelection = Yt(this.joinSegs)),
          (this.joinBusinessHours = Yt(this.joinSegs)),
          (this.joinFgEvents = Yt(this.joinSegs)),
          (this.joinBgEvents = Yt(this.joinSegs)),
          (this.joinEventDrags = Yt(this.joinInteractions)),
          (this.joinEventResizes = Yt(this.joinInteractions));
      }
      return (
        (e.prototype.joinProps = function (e, t) {
          for (
            ...
            n.push(f.dateSelectionSegs),
              r.push(p ? f.businessHourSegs : Ed),
              i.push(p ? f.fgEventSegs : Ed),
        ...
        (e.prototype.joinInteractions = function (e) {
          for (var t = [], n = 1; n < arguments.length; n++)
            t[n - 1] = arguments[n];
          for (
            var o = e.resources.length, i = {}, a = [], s = !1, l = !1, u = 0;
            u < o;
            u += 1
          ) {
            var c = t[u];
      ...
      return (
        ...
        (t.prototype.getKeyInfo = function (e) {
          var t = e.resourceDayTableModel,
            n = yt(t.resourceIndex.indicesById, function (e) {
  ...
  function Dd(e, t) {
    return Rd(e, [], t, !1, {}, !0).map(function (e) {
      return e.resource;
    });
  }
      ...
      wd(
        (function (e, t, n, r) {
          var o = (function (e, t) {
              ...
              for (var r in e) {
                var o = e[r];
                n[r] = { resource: o, resourceFields: xd(o), children: [] };
              }
              for (var r in e) {
                if ((o = e[r]).parentId) {
                  var i = n[o.parentId];
                  i && _d(n[r], i.children, t);
                }
              }
              return n;
            })(e, r),
          ...
          for (var a in o) {
            var s = o[a];
            s.resource.parentId || Td(s, i, n, 0, t, r);
          }
          return i;
        })(e, r ? -1 : 1, t, n),
        a,
    ...
    for (var s = 0; s < e.length; s += 1) {
      ...
      if (u)
        if (n) {
          var c = t.length,
            d = r.length;
          if ((wd(l.children, t, n, r.concat(0), o, i, a), c < t.length)) {
            var p = t[c];
          ...
          (function (e, t, n) {
            ...
            if (n.order)
              for (o = 0; o < t.length; o += 1) {
                if ((s = t[o]).group) {
                  var a = je(i, s.group.value) * n.order;
                  if (0 === a) {
                    r = s;
                    break;
                  }
  ...
  function _d(e, t, n) {
    ...
    for (r = 0; r < t.length; r += 1) {
      if (Fe(t[r].resourceFields, e.resourceFields, n) > 0) break;
    }
    t.splice(r, 0, e);
  }
  ...
  var Md = Go({
      ...
      reducers: [
        function (e, t, n) {
          var o = Zc(e && e.resourceSource, t, n);
          return {
            resourceSource: o,
            resourceStore: td(e && e.resourceStore, t, o, n),
      ...
      isDraggableTransformers: [
        function (e, t, n, r) {
          if (!e) {
            ...
            if (
              o.viewSpecs[o.currentViewType].optionDefaults.needsResourceData &&
              Ac(t, r)
            )
              return !0;
          }
      ...
      eventDragMutationMassagers: [
        function (e, t, n) {
          ...
          r &&
            o &&
            r !== o &&
            (e.resourceMutation = { matchResourceId: r, setResourceId: o });
        },
      ],
      eventDefMutationAppliers: [
        function (e, t, n) {
      ...
      viewPropsTransformers: [Wc, Uc],
      isPropsValid: function (e, t) {
        var n = new od().splitProps(
          r(r({}, e), { resourceStore: t.getCurrentData().resourceStore })
        );
        for (var o in n) {
          var i = n[o];
          if (
            (o &&
              n[""] &&
              (i = r(r({}, i), {
                eventStore: Tn(n[""].eventStore, i.eventStore),
                eventUiBases: r(r({}, n[""].eventUiBases), i.eventUiBases),
              })),
            !Oa(i, t, { resourceId: o }, id.bind(null, o)))
          )
            return !1;
        }
        return !0;
        ...
        resourceStore: function (e, t) {
          ...
          n.hasHandlers("resourcesSet") &&
            n.trigger(
              ...
              (function (e, t) {
                var n = [];
                for (var r in e) n.push(new rd(t, e[r]));
                return n;
              })(e, t)
            );
        },
    ...
    Id = (function (e) {
      function t() {
        ...
        return (
          ...
          (t.isHitComboAllowed = function (e, n) {
            return (
              1 === t.props.resourceDayTableModel.dayTableModel.colCnt ||
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          this.slicers = yt(s, function (t, n) {
            return e.slicers[n] || new El();
          });
          var l = yt(this.slicers, function (e, t) {
    ...
    Nd = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.flattenResources = Yt(Dd)),
          (t.buildResourceDayTableModel = Yt(Hd)),
          (t.headerRef = ko()),
          (t.tableRef = ko()),
          t
        );
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return r.dayMinWidth
            ? this.renderHScrollLayout(s, l, a.colCnt, r.dayMinWidth)
  ...
  function Hd(e, t, n, r, o) {
    var i = Dl(e, t);
    return r ? new Sd(i, n, o) : new yd(i, n, o);
  }
  var Od = Go({
      deps: [xu, Md, Rl],
    ...
    Wd = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          this.slicers = yt(u, function (t, n) {
            return e.slicers[n] || new tu();
          });
          var c = yt(this.slicers, function (e, t) {
            ...
            function (n, o) {
              return _o(
                ...
                r({ ref: e.timeColsRef }, e.joiner.joinProps(c, s), {
                  ...
                  nowDate: n,
                  nowIndicatorSegs:
                    i.nowIndicator && e.buildNowIndicatorSegs(n),
                  todayRange: o,
                  onScrollTopRequest: t.onScrollTopRequest,
                  forPrint: t.forPrint,
                  onSlatCoords: t.onSlatCoords,
    ...
    Ld = (function (e) {
      function t() {
        ...
        return (
          (t.flattenResources = Yt(Dd)),
          (t.buildResourceTimeColsModel = Yt(Ud)),
          (t.buildSlatMetas = Yt(iu)),
          t
        );
      }
      return (
  ...
  function zd(e) {
    for (
      ...
      a.push(_o("span", { className: "fc-icon" }));
    var l = ["fc-icon"];
    return (
      ...
      a.push(
        _o(
          ...
          _o("span", { className: l.join(" ") })
        )
      ),
      _o.apply(void 0, o([Mo, {}], a))
    );
  }

  function Vd(e) {
    return {
      resource: new rd(e.context, e.resource),
  ...
  function Gd(e) {
    return e.fieldValue || _o(Mo, null, " ");
  }
  var jd = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.refineHookProps = Zt(Vd)),
          (t.normalizeClassNames = Qo()),
            ...
            function (n) {
              return _o(
                "td",
                {
                  ...
                  className: ["fc-datagrid-cell", "fc-resource"]
                    .concat(i)
                    .join(" "),
                },
                _o(
          ...
          return _o(
            ...
            function (t, n, r, o) {
              return _o(
                "td",
                {
                  className: ["fc-datagrid-cell", "fc-resource-group"]
                    .concat(n)
                    .join(" "),
                  rowSpan: e.rowSpan,
                  ref: t,
                ...
                _o(
                  ...
                  _o(
                    "div",
                    { className: "fc-datagrid-cell-cushion fc-sticky", ref: r },
                    o
                  )
                )
              );
  ...
  function Yd(e) {
    return e.groupValue || _o(Mo, null, " ");
  }
  var Zd = (function (e) {
    function t() {
      return (null !== e && e.apply(this, arguments)) || this;
      ...
      (t.prototype.render = function () {
        ...
        return _o(
          ...
          e.colSpecs.map(function (i, a) {
            ...
            if (0 === s) return null;
            null == s && (s = 1);
            var l = i.field ? o[i.field] : t.title || ed(t.id);
            return s > 1
              ? _o(qd, { key: a, colSpec: i, fieldValue: l, rowSpan: s })
              : _o(jd, {
                  key: a,
                  colSpec: i,
                  resource: t,
  ...
  Zd.addPropsEquality({ rowSpans: qt });
  var Xd = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
              ...
              return _o(
                ...
                _o(
                  ...
                  _o(
                    ...
                    _o(
                      "span",
                      { className: "fc-datagrid-cell-main", ref: i },
                      a
                    )
                  )
                )
  ...
  Xd.addPropsEquality({ group: kd });
  var $d = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.resizerElRefs = new Va(t._handleColResizerEl.bind(t))),
          (t.colDraggings = {}),
          t
        );
      }
      return (
                          ...
                          _o(
                            ...
                            t.isMain &&
                              _o(
                                ...
                                _o("span", { className: "fc-icon" })
                              ),
                            _o(
                              "span",
                              { className: "fc-datagrid-cell-main", ref: a },
                              s
                            )
                          ),
                          !o &&
        ...
        (t.prototype._handleColResizerEl = function (e, t) {
          var n,
            r = this.colDraggings;
          e
            ? (n = this.initColResizing(e, parseInt(t, 10))) && (r[t] = n)
    ...
    Jd = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = { resource: new rd(t, e.resource) };
          return _o(
            Ko,
            { hookProps: n, content: t.options.resourceLaneContent },
            function (e, t) {
              return (
                t &&
                _o("div", { className: "fc-timeline-lane-misc", ref: e }, t)
              );
            }
          );
        }),
  ...
  function ep(e) {
    return { resource: new rd(e.context, e.resource) };
  }
  var tp = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
                ...
                return _o(
                  "td",
                  {
                    ...
                    className: [
                      "fc-timeline-lane",
                      "fc-resource-group",
                      e.context.theme.getClass("tableCellShaded"),
                    ]
                      .concat(r)
                      .join(" "),
                  },
                  _o("div", { style: { height: t.innerHeight }, ref: o }, i)
                );
              }
            )
          );
    ...
    rp = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.rootElRef = ko()), (t.rowElRefs = new Va()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
          ...
          return _o(
            "table",
            {
              ref: this.rootElRef,
              className:
                "fc-scrollgrid-sync-table " + t.theme.getClass("table"),
              style: {
                minWidth: e.tableMinWidth,
                width: e.clientWidth,
                height: e.minHeight,
  ...
  var op = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.computeHasResourceBusinessHours = Yt(ip)),
        (t.resourceSplitter = new od()),
        (t.bgSlicer = new _c()),
        (t.slatsRef = ko()),
        (t.state = { slatCoords: null }),
        (t.handleEl = function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          p =
            r.slatCoords && r.slatCoords.dateProfile === n.dateProfile
              ? r.slatCoords
              : null;
        return _o(
          "div",
            ...
            return _o(
              ...
              o.options.nowIndicator &&
                ...
                _o(
                  "div",
                  { className: "fc-timeline-now-indicator-container" },
                  _o(as, { isAxis: !1, date: t }, function (e, n, r, i) {
                    return _o(
                      "div",
                      {
                        ref: e,
                        className: ["fc-timeline-now-indicator-line"]
                          .concat(n)
                          .join(" "),
                        style: Sc(p.dateToCoord(t), o.isRtl),
                      },
                      i
                    );
                  })
  ...
  var ap = (function (e) {
      function t() {
        ...
        return (
          (t.scrollGridRef = ko()),
          (t.timeBodyScrollerElRef = ko()),
          (t.spreadsheetHeaderChunkElRef = ko()),
          (t.rootElRef = ko()),
          ...
          (t.ensureScrollGridResize = function () {
            t.ensureScrollGridResizeId &&
              ...
              }, sa.SCROLLGRID_RESIZE_INTERVAL + 1));
          }),
          t
        );
      }
    ...
    sp = (function (e) {
      function t(t, n) {
        var r = e.call(this, t, n) || this;
        return (
          (r.processColOptions = Yt(dp)),
          (r.buildTimelineDateProfile = Yt(ac)),
          (r.hasNesting = Yt(cp)),
          (r.buildRowNodes = Yt(Rd)),
          (r.layoutRef = ko()),
          (r.rowNodes = []),
          (r.renderedRowNodes = []),
          (r.buildRowIndex = Yt(lp)),
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            v = [
              ...
              this.hasNesting(h) ? "" : "fc-resource-timeline-flat",
              "fc-timeline",
              !1 === i.eventOverlap
            ...
            g = i.slotMinWidth,
            m = Hc(f, g || this.computeFallbackSlotMinWidth(f));
          return _o(ni, { viewSpec: a }, function (t, i) {
            return _o(
              "div",
              ...
              _o(ap, {
                ...
                spreadsheetCols: up(p, r.spreadsheetColWidths, ""),
                ...
                spreadsheetBodyRows: function (t) {
                  return _o(
                    Mo,
                    null,
                    e.renderSpreadsheetRows(h, p, t.rowSyncHeights)
                  );
                },
                timeCols: m,
  ...
  function dp(e) {
    ...
    for (var f = [], h = 0, v = e.resourceOrder || ld; h < v.length; h++) {
  ...
  sp.addStateEquality({ spreadsheetColWidths: qt });
  var pp = Go({
    deps: [xu, Md, Oc],
  ...
  return (
    ki.push(Js, Rl, lu, Su, Cu, Du, $u, ec, Oc, Md, Od, Bd, pp),
    (e.AbstractResourceDayTableModel = md),
    (e.BASE_OPTION_DEFAULTS = fn),
    (e.BASE_OPTION_REFINERS = pn),
    (e.BaseComponent = Uo),
    (e.BgEvent = ps),
    (e.BootstrapTheme = Eu),
    (e.Calendar = Rs),
    ...
    (e.CalendarDataManager = Oi),
    (e.CalendarDataProvider = qi),
    (e.CalendarRoot = ya),
    (e.Component = To),
    (e.ContentHook = Ko),
    (e.CustomContentRenderContext = Xo),
    (e.DEFAULT_RESOURCE_ORDER = ld),
    (e.DateComponent = Fo),
    (e.DateEnv = Ur),
    (e.DateProfileGenerator = si),
    (e.DayCellContent = ls),
    (e.DayCellRoot = cs),
    (e.DayGridView = bl),
    (e.DayHeader = Ta),
    (e.DayResourceTableModel = Sd),
    (e.DaySeriesModel = xa),
    (e.DayTable = Cl),
    (e.DayTableModel = ka),
    (e.DayTableSlicer = El),
    ...
    (e.MoreLinkRoot = ys),
    (e.MountHook = Jo),
    (e.NamedTimeZoneImpl = Yi),
    (e.NowIndicatorRoot = as),
    (e.NowTimer = Ra),
    (e.PointerDragging = xs),
    (e.PositionCache = Co),
    (e.RefMap = Va),
    (e.RenderHook = Zo),
    (e.ResourceApi = rd),
    (e.ResourceDayHeader = hd),
    (e.ResourceDayTable = Id),
    (e.ResourceDayTableModel = yd),
    (e.ResourceDayTableView = Nd),
    (e.ResourceDayTimeCols = Wd),
    (e.ResourceDayTimeColsView = Ld),
    (e.ResourceLabelRoot = dd),
    (e.ResourceSplitter = od),
    (e.ResourceTimelineLane = Qd),
    (e.ResourceTimelineView = sp),
    (e.ScrollController = bo),
    (e.ScrollGrid = Uu),
    (e.ScrollResponder = Oo),
    (e.Scroller = za),
    (e.SegHierarchy = Zi),
    (e.SimpleScrollGrid = ns),
    (e.Slicer = Ma),
    (e.Splitter = ro),
    (e.SpreadsheetRow = Zd),
    (e.StandardEvent = os),
    ...
    (e.TableView = Qs),
    (e.Theme = wo),
    (e.ThirdPartyDraggable = $s),
    (e.TimeCols = Ql),
    (e.TimeColsSlatsCoords = Nl),
    (e.TimeColsView = Pl),
    (e.TimelineCoords = mc),
    (e.TimelineHeader = Cc),
    (e.TimelineHeaderRows = gc),
    (e.TimelineLane = Pc),
    (e.TimelineLaneBg = Tc),
    (e.TimelineLaneSlicer = _c),
    (e.TimelineSlats = Rc),
    (e.TimelineView = Nc),
    (e.VResourceJoiner = Cd),
    (e.VResourceSplitter = bd),
    (e.ViewApi = wr),
    (e.ViewContextType = Ao),
    (e.ViewRoot = ni),
    (e.WeekNumberRoot = hs),
    (e.WindowScrollController = Ro),
    (e.addDays = Je),
    (e.addDurations = Nt),
    (e.addMs = Qe),
    (e.addWeeks = $e),
    ...
    (e.asRoughSeconds = Wt),
    (e.binarySearch = ta),
    (e.buildClassNameNormalizer = Qo),
    (e.buildDayRanges = ru),
    (e.buildDayTableModel = Dl),
    (e.buildEntryKey = Ki),
    (e.buildEventApis = Nr),
    (e.buildEventRangeKey = pr),
    ...
    (e.buildIsoString = zt),
    (e.buildNavLinkData = lo),
    (e.buildResourceFields = xd),
    (e.buildRowNodes = Rd),
    (e.buildSegCompareObj = ir),
    (e.buildSegTimeText = ur),
    (e.buildSlatCols = Hc),
    (e.buildSlatMetas = iu),
    (e.buildTimeColsModel = su),
    (e.buildTimelineDateProfile = ac),
    (e.collectFromHash = wt),
    (e.combineEventUis = In),
    (e.compareByFieldSpec = Ge),
    ...
    (e.computeInnerRect = go),
    (e.computeRect = mo),
    (e.computeSegDraggable = ar),
    (e.computeSegEndResizable = lr),
    (e.computeSegStartResizable = sr),
    (e.computeShrinkWidth = Fa),
    (e.computeSmallestCellWidth = Xe),
    (e.computeVisibleDayRange = Vn),
    (e.config = sa),
    (e.constrainPoint = Jr),
    (e.coordToCss = Sc),
    (e.coordsToCss = Ec),
    ...
    (e.createEventInstance = ht),
    (e.createEventUi = Pn),
    (e.createFormatter = dn),
    (e.createPlugin = Go),
    (e.createPortal = Io),
    (e.createRef = ko),
    (e.diffDates = Gn),
    ...
    (e.elementMatches = Ce),
    (e.enableCursor = We),
    (e.eventTupleToStore = Dn),
    (e.filterEventStoreDefs = _n),
    (e.filterHash = mt),
    (e.findDirectChildren = De),
    (e.findElements = be),
    (e.flattenResources = Dd),
    ...
    (e.formatRange = function (e, t, n) {
      ...
      return i && a
        ? r.formatRange(i.marker, a.marker, o, {
            ...
            defaultSeparator: fn.defaultRangeSeparator,
          })
        : "";
    }),
    (e.getAllowYScrolling = ja),
    (e.getCanVGrowWithinCell = to),
    (e.getClippingParents = yo),
    (e.getDateMeta = io),
    (e.getDayClassNames = ao),
    (e.getDefaultEventEnd = Cr),
    (e.getElRoot = xe),
    (e.getElSeg = tr),
    (e.getEntrySpanEnd = Xi),
    (e.getEventClassNames = dr),
    (e.getEventTargetViaRoot = _e),
    (e.getIsRtlScrollbarOnLeft = po),
    (e.getPublicId = ed),
    (e.getRectCenter = Qr),
    (e.getRelevantEvents = Rn),
    (e.getScrollGridClassNames = $a),
    (e.getScrollbarWidths = fo),
    (e.getSectionClassNames = Ja),
    (e.getSectionHasLiquidHeight = Ga),
    (e.getSegMeta = cr),
    (e.getSlotClassNames = so),
    (e.getStickyFooterScrollbar = ts),
    (e.getStickyHeaderDates = es),
    (e.getUnequalProps = bt),
    (e.globalLocales = Br),
    (e.globalPlugins = ki),
    (e.greatestDurationDenominator = Bt),
    (e.groupIntersectingEntries = $i),
    (e.guid = Oe),
    (e.hasBgRendering = Qn),
    (e.hasShrinkWidth = Ka),
    (e.identity = Cn),
    (e.interactionSettingsStore = ia),
    (e.interactionSettingsToStore = oa),
    (e.intersectRanges = Yn),
    (e.intersectRects = Kr),
    (e.intersectSpans = Qi),
    (e.isArraysEqual = qt),
    (e.isColPropsEqual = Ya),
    (e.isDateSelectionValid = Na),
    (e.isDateSpansEqual = vr),
    (e.isGroupsEqual = kd),
    (e.isInt = Ze),
    (e.isInteractionValid = Ia),
    (e.isMultiDayRange = Fn),
    (e.isPropsEqual = Ct),
    (e.isPropsValid = Oa),
    (e.isValidDate = pt),
    (e.joinSpans = Ji),
    (e.listenBySelector = Pe),
    (e.mapHash = yt),
    (e.memoize = Yt),
    (e.memoizeArraylike = Xt),
    (e.memoizeHashlike = Kt),
    (e.memoizeObjArg = Zt),
    (e.mergeEventStores = Tn),
    (e.multiplyDuration = Ht),
    (e.padStart = qe),
    (e.parseBusinessHours = Zr),
    (e.parseClassNames = xn),
    (e.parseDragMeta = ua),
    (e.parseEventDef = Bn),
    (e.parseFieldSpecs = Ve),
    (e.parseMarker = Lr),
    (e.pointInsideRect = Xr),
    (e.preventContextMenu = Be),
    (e.preventDefault = ke),
    (e.preventSelection = Le),
    (e.rangeContainsMarker = $n),
    (e.rangeContainsRange = Kn),
    (e.rangesEqual = Zn),
    (e.rangesIntersect = Xn),
    (e.refineEventDef = Ln),
    (e.refineProps = En),
    (e.removeElement = Se),
    (e.removeExact = jt),
    (e.render = xo),
    (e.renderChunkContent = qa),
    (e.renderFill = ds),
    (e.renderMicroColGroup = Za),
    (e.renderScrollShim = Qa),
    (e.requestJson = Ti),
    (e.sanitizeShrinkWidth = Xa),
    (e.setElSeg = er),
    (e.setRef = Vo),
    (e.setScrollFromLeftEdge = Iu),
    ...
    (e.startOfDay = it),
    (e.translateRect = $r),
    (e.triggerDateSelect = Sr),
    (e.unmountComponentAtNode = Ho),
    (e.unpromisify = So),
    (e.version = "5.9.0"),
    (e.whenTransitionDone = Ne),
    (e.wholeDivideDurations = Ut),
